...
java -jar basic/target/libs/hibernate-orm-benchmark-basic-1.0-SNAPSHOT-jmh.jar EntityInstantiators -ppolluteAtWarmup=false -pmorphism=MONO,QUAD -pinstantiation=STANDARD -penhance=true -pcount=1000 \
